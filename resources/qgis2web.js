...
map.getView().fit([-51045.452316, 615068.273915, -14137.797970, 651934.665347], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Intervention for food-Environmental map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (74 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is a web map to show the Intervention for the Food -Environmental map';
            }
